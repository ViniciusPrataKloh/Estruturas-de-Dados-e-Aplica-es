...
int insert(Tree** tree, int value){
  ...
  if((*tree)->root->value > value){                                                                                                             Tree* aux = (Tree*) malloc(sizeof(Tree));
      aux->root = (*tree)->root->left;
        if(insert(&aux, value)){
          ...
          if(balancing(&(*tree)->root) >= 2){
            ...
            ret = 0;
      } else if((*tree)->root->value < value){                                                                                                             Tree* aux = (Tree*) malloc(sizeof(Tree));
...
int delete(Tree** tree, int value){
  ...
  if((*tree)->root->value > value){                                                                                                             Tree* aux = (Tree*) malloc(sizeof(Tree));
    aux->root = (*tree)->root->left;
    if(delete(&(aux), value)){
      (*tree)->root->left = aux->root;                                                                                                             free(aux);
      if(balancing(&(*tree)->root) >= 2){
...
int print_tree(Tree** tree, int i){
  int j;                                                                                                                                                                                                                          Tree* aux = (Tree*) malloc(sizeof(Tree));
  aux->root = (*tree)->root;
  if(!(*tree)->root)
    return 0;
  if(aux->root->right){
